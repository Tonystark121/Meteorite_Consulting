...
const apparel = () => {
  ...
  return (
    <div className="pt-[270px] flex flex-col gap-6 m-auto">
      ...
      <p className="text-center text-gray-400 font-light text-xl mx-auto mt-2 leading-relaxed">
      ...
      <div className="flex flex-row items-center gap-24 pt-5 justify-center ">
        <Button className="" />
        <a
